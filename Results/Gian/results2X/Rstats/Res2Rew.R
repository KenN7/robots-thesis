...
generateplotsimpr <- function(datasim, datapr, task, max) {
  ...
  axis(1, at=c(1.5, 4, 6.5, 9, 11.5, 14), labels=c("\\texttt{EvoCom2}", "", "\\texttt{Gianduja2E}", "", "\\texttt{Gianduja3}", ""), tick=FALSE, mgp=c(0,0.2,0))
  axis(1, at=c(1.5, 4, 6.5, 9, 11.5, 14), labels=c("", "\\texttt{Gianduja2}", "", "\\texttt{EvoCom3}", "", "\\texttt{Gianduja3E}"), tick=FALSE, mgp=c(0,1.2,0))
