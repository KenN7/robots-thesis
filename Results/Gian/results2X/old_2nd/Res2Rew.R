...
generateplotsimpr <- function(datasim, datapr, task, max) {
  ...
  evo3Xsim = data2sim[which(data2sim[,3]=='EvoCom3X'), 1]
  evo2Xsim = data2sim[which(data2sim[,3]=='EvoCom2X'), 1]
  ...
  evo3Xpr = data2pr[which(data2pr[,3]=='EvoCom3X'), 1]
  evo2Xpr = data2pr[which(data2pr[,3]=='EvoCom2X'), 1]
  ...
  boxplot( gian2sim, gian2pr,   gian2Esim, gian2Epr,    evo2sim, evo2pr,   evo2Xsim, evo2Xpr,   gian3sim, gian3pr,   gian3Esim, gian3Epr,    evo3sim, evo3pr,  evo3Xsim, evo3Xpr,
          at =c(1, 2,    3.5, 4.5,    6, 7,    8.5, 9.5,    11, 12,    13.5, 14.5,    16, 17,    18.5, 19.5),
          axes=FALSE,
          notch=FALSE,
          cex=0.5,
          #type="l",
          ...
          #ylim = c(0,130),
          #ylab="Objective function",
          width=c(0.5, 2,    0.5, 2,   0.5, 2,    0.5, 2,    0.5, 2,   0.5, 2,   0.5, 2,   0.5, 2),
          names=list_methods)
  ...
  abline(v=17.75, lty=3, col="gray")
  
  axis(1, at=c(1.5, 4, 6.5, 9, 11.5, 14, 16.5, 19), labels=c("\\texttt{Gianduja2}", "", "\\texttt{EvoCom2}", "", "\\texttt{Gianduja3}", "", "\\texttt{EvoCom3}", ""), tick=FALSE, mgp=c(0,0.2,0))
  axis(1, at=c(1.5, 4, 6.5, 9, 11.5, 14, 16.5, 19), labels=c("",        "\\texttt{Gianduja2E}", "", "\\texttt{EvoCom2X}", "", "\\texttt{Gianduja3E}", "", "\\texttt{EvoCom3X}"), tick=FALSE, mgp=c(0,1.2,0))
