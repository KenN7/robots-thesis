...
generateplotsimpr <- function(datasim, datapr, datareal, task, max) {
  ...
  list_methods <- c("EvoCom","EvoComPR", "EvoComR", "Gianduja", "GiandujaPR", "GiandujaR", "GiandujaE", "GiandujaEPR", "Chocolate", "ChocolatePR", "ChocolateR")
  ...
  boxplot(chocosim, chocopr, chocoreal,   evosim, evopr, evoreal,     giansim, gianpr, gianreal,      gianEsim, gianEpr,    
          at =c(1, 2, 3,   4.5,5.5,6.5,  8,9,10,   11.5,12.5 ),
          axes=FALSE,
          notch=FALSE,
          cex=0.5 ,
          #type="l",
          ...
          col=c("gray", "gray", "white",    "gray", "gray", "white",      "gray", "gray", "white",       "gray", "gray"),
          #ylim = c(0,130),
          width=c(0.5, 2, 2,    0.5, 2, 2,    0.5, 2, 2,    0.5, 2 ),
          names=list_methods)
  abline(v=3.75, lty=3, col="gray")
  abline(v=7.25, lty=3, col="gray")
  abline(v=10.75, lty=3, col="gray")
  #abline(v=13.25, lty=3, col="gray")
  #abline(v=15.75, lty=3, col="gray")
  #abline(v=18.25, lty=3, col="gray")
  axis(1, at =c(2,5.5,9,12), labels=c("\\texttt{Chocolate}","\\texttt{EvoCom}", "\\texttt{Gianduja}", "\\texttt{GiandujaE}"), tick=FALSE, mgp=c(0,0.2,0))
